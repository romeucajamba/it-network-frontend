...
export const RecoverPassword = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    console.log("Password recovery submitted:", { username, email, newPassword });
  };
            ...
            <div className="max-w-md mx-auto w-full">
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <Link href="/login">
                  <Button
                  type="submit"
                  className="w-full bg-gradient-to-r from-blue-500 to-purple-600 hover:from-blue-600 hover:to-purple-700 text-white py-4 rounded-full text-lg font-medium transition-all duration-300 hover:scale-105 shadow-lg mt-8"
                  >
                  Entrar
                  </Button>
                </Link>
